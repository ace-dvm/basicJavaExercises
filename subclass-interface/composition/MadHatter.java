...
/**
 * MadHatters are a kind of WonderousThing
 * 
 * @author (ace) 
 * @version (1 June 2010)
 */
public class MadHatter implements WonderousThings
{

    private Wonderous w;

    /**
     * Constructor for objects of class MadHatter
     */
    public MadHatter(Wonderous w)
    {
        this.w = w;
    }
